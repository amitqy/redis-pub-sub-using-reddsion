...
public class AppIntializer implements ServletContextListener{
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
		...
		System.out.println("redis client initialized!! on server 2");
       ...
       servletContext.setAttribute("dbProperties", dbProperties);
           ...
           RPatternTopic  expiredTopic = redissonClient.getPatternTopic("expiredPassword");
            expiredTopic.addListener(String.class, (pattern, channel, expiredKey) -> {
           System.out.println("Password expired for user:: " + expiredKey);
